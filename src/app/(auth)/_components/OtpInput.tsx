...
export default function OtpInput({ onVerify, verifyLabel = "Verify Account" }: OtpInputProps) {
    const { otp, inputRefs, value, handleChange, handleKeyDown, handlePaste } = useOtp();
