    ...
    return (
        <div className=" rounded-xs  pt-6">
            ...
            <div className="space-y-6">
                {packages.map((pkg) => (
                    <div key={pkg.id} className="border-b last:border-b-0 pb-4 flex flex-col sm:flex-row space-y-5 sm:items-center justify-between relative">
                        <div className='space-y-1'>
                            <div className={`${typography.textBase} font-semibold`}>{pkg.title}</div>
                            <div className="text-xs text-dark-gray">{pkg.subtitle}</div>
                            <div className="text-xs text-dark-gray">{pkg.details}</div>
                        </div>
                        <div className='space-y-1'>
