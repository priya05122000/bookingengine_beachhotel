                    ...
                    <div className="border border-primary bg-white ">
                        ...
                        <div className='p-5'>
                            <p className="text-sm text-dark-gray leading-relaxed mb-4">
                                Enjoy A Delightful Stay At Unbelievable Prices At Our Rooms That Come With A Host Of Amenities.
                                Check In Time: 14:00 Hrs Check Out Time: 11:00 AM
                            </p>

                            <h5 className={`${typography.textTwoXl} font-bold text-primary mb-2`}>Cancellation Rules</h5>
                            <p className="text-sm text-dark-gray leading-relaxed mb-5">
                                If Cancellation Is Done 2 Or More Days Prior To Arrival, Then Full Amount Will Be Refunded.
                ...
                <aside className="w-full shadow-[-1px_4px_4px_0px_#00000040]">
                    <div className="bg-white shadow-sm">
                        ...
                        <div className="p-4">
                            ...
                            <p className="text-sm text-dark-gray mt-1">1NIGHT | 1ROOM | 2ADULT</p>
                            ...
                            <div className="mt-3 pt-3 border-t border-gray-100">
                                ...
                                <div className="flex items-baseline justify-between mt-2 pt-2 border-t border-gray-100">
                                    ...
                                    <span className="text-sm font-extrabold text-primary">INR 82,45,678</span>
                                </div>
                            </div>
                        </div>
                    </div>
