...
export default function Footer() {
  return (
    <Section className="bg-primary w-full relative text-white overflow-hidden z-10 pt-12 lg:pt-18 pb-6 lg:h-160 xl:h-170">
      <div className="h-full flex flex-col justify-between font-arizona-light">
        <div>
          {" "}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr] gap-10 lg:gap-6">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div>
                <Link
                  href="/booking"
                  className="inline-flex items-center text-white px-4 h-10 rounded-xs text-xs lg:text-sm font-arizona-sans-regular tracking-widest cursor-pointer bg-accent"
                >
                  Book My Stay
                </Link>
              </div>
